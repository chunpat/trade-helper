...
class PolymarketCopyStrategy(Base, BaseMixin):
    ...
    copy_ratio = Column(Float, nullable=False, default=1.0)
    min_copy_order_usdc = Column(Float, nullable=False, default=0.0)
    max_order_usdc = Column(Float, nullable=False, default=0.0)
    max_position_notional_usdc = Column(Float, nullable=False, default=0.0)
    max_market_exposure_usdc = Column(Float, nullable=False, default=0.0)
...
class PolymarketCopySourcePosition(Base, BaseMixin):
    ...
    estimated_follower_size = Column(Float, nullable=False, default=0.0)
    estimated_follower_notional_usdc = Column(Float, nullable=False, default=0.0)
...
class PolymarketCopySignalLog(Base, BaseMixin):
    ...
    source_trade_size = Column(Float, nullable=False, default=0.0)
    ...
    live_execution_status = Column(String(32), nullable=True)
    live_order_id = Column(String(255), nullable=True, index=True)
    live_order_status = Column(String(64), nullable=True)
    live_execution_error = Column(Text, nullable=True)
    live_order_response = Column(JSON, nullable=True)
    live_executed_at = Column(DateTime, nullable=True)
    live_canceled_at = Column(DateTime, nullable=True)
    live_cancel_response = Column(JSON, nullable=True)
    live_cancel_error = Column(Text, nullable=True)
